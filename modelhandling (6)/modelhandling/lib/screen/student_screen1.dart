...
// import '../controller/student_controller1.dart';
...
//             TextField(controller: _gpaController, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: 'GPA')),
...
//               final newGPA = double.tryParse(_gpaController.text.trim()) ?? 0.0;
...
//                 final success = _controller.updateStudent(id, newName, newCourse, newGPA);

//                 _showMessage(success ? 'Student updated.' : 'Update failed.');
